...
import { Scissors, Sparkles, Download, Lock, Unlock, Crown, ArrowUpRight } from "lucide-react";
    ...
    try {
      ...
      if (data.success) {
        ...
        const newCreation = {
          ...
          prompt: `Removed ${object || "object"} from image`,
    ...
    <div className="h-full overflow-y-auto p-4 sm:p-6 flex items-start flex-wrap lg:flex-nowrap gap-6 text-gray-200 tracking-[-0.02em]">
      ...
      >
        ...
        {!isPremium && (
          <div className="mt-4 p-4 rounded-xl bg-gradient-to-r from-[#FF4D5E]/15 to-transparent border border-[#FF4D5E]/30 flex flex-col gap-2.5">
            ...
            <p className="text-xs text-gray-300">
              Upgrade to the Premium Plan to erase unwanted objects from any image seamlessly with AI.
            </p>
            <button
              type="button"
        ...
        >
          ...
          {isPremium ? "Erase Object" : "Unlock with Pro ($19/mo)"}
        </button>
      </form>
